...
defGroup('group2h', property.h3) do |node|
  node.addApplication("runHost") do |app|
    app.setProperty('content_id_add', '1 2 3 4 5')
  end
end
...
defGroup('group4h', property.h4) do |node|
  node.addApplication("runHost") do |app|
    app.setProperty('content_id_add', '1 2 3 4 5')
  end
end
...
defGroup('group7h', property.h5) do |node|
  node.addApplication("runHost") do |app|
    app.setProperty('content_id_add', '1 2 3 4 5')
  end
end
...
#Group2
  after 20 do
    ...
    group('group2h').startApplications
  end
...
#Group 4
  after 45 do
    ...
    group('group4h').startApplications
  end
...
#Group 7
  after 95 do
    ...
    group('group7h').startApplications
  end
